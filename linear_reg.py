...
st.write("""
## 🧠 Summary
- Multiple Linear Regression predicts `y` based on multiple independent variables (`X1`, `X2`, ...).
- It uses the least squares method to find the best fit line (or hyperplane) to explain the relationship between `X` and `y`.
""")
